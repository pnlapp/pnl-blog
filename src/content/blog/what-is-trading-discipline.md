---
title: "What Is Trading Discipline?"
description: "Trading discipline is following your own rules on the trades where it is hardest to, not just on the easy ones. It is a behavior you can measure, not just a personality trait."
slug: "what-is-trading-discipline"
...
sources: []
keyTakeaways:
  - "Trading discipline means following your own predefined rules, especially on the trades where breaking them feels justified."
  - "It is a measurable pattern of behavior, not a fixed personality trait someone either has or does not."
  - "The clearest evidence of discipline shows up right after a loss or a win, when the temptation to deviate is highest."
faq:
  - question: "Is trading discipline something you either have or do not have?"
    answer: "No. It behaves more like a skill that varies by situation than a fixed trait. Most traders are disciplined in calm conditions and lose that discipline specifically after losses or winning streaks, which is why those moments are the ones worth tracking."
---
...
If you want a quick read on your own patterns, the [trading discipline score](https://pnlapp.co/trading-discipline-score) is built around exactly this kind of behavioral data.
