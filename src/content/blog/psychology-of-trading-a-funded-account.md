---
title: "The Psychology of Trading a Funded Account"
description: "Trading someone else's capital under a set of rules changes the psychology of every decision, even when the strategy is identical to trading your own account."
slug: "psychology-of-trading-a-funded-account"
...
sources: []
keyTakeaways:
  - "Trading a funded account under a daily loss limit changes the emotional weight of a losing trade compared to a personal account."
  - "Fear of breaching a rule can push a trader toward overly cautious decisions that are just as costly as overtrading."
  - "Treating the evaluation rules as fixed constraints, planned for in advance, works better than trying to avoid thinking about them."
---
...
If you're managing this across a funded account specifically, the [prop trader journal](https://pnlapp.co/prop-trader-journal) guide covers what is worth tracking against those rules.
