---
title: "Patterns in Retail Trader Behavior After a Losing Streak"
description: "How does position sizing and trade frequency typically shift after a string of losses? A look at the behavioral pattern, with an illustrative example of how it tends to show up."
slug: "retail-trader-behavior-after-losing-streak"
contentType: "research"
category: "Behavioral Research"
tags: ["trader behavior", "research", "drawdown", "risk management"]
...
draft: false
sources:
  - title: "Barber & Odean, Trading Is Hazardous to Your Wealth"
    url: "https://faculty.haas.berkeley.edu/odean/"
keyTakeaways:
  - "Losing streaks tend to coincide with larger position sizes and higher trade frequency, not more caution."
  - "This pattern is consistent with loss aversion rather than a change in strategy quality."
  - "Tracking your own size and frequency around losses is more useful than tracking win rate alone."
faq:
  - question: "Is this based on a specific published dataset?"
    answer: "This article describes a general behavioral pattern that shows up across trading psychology literature. The illustrative figures used here are for explanation only and are not drawn from a specific verified study."
  - question: "Does this pattern apply to every trader?"
    answer: "No. It describes a common tendency, not a rule. Some traders reduce size and frequency after losses instead, and tracking your own behavior is the only reliable way to know which pattern applies to you."
---
