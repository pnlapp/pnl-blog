...
description: "Revenge trading is entering a new trade to win back a loss, rather than because a real setup appeared. It is one of the most common ways a small loss becomes a large one."
slug: "what-is-revenge-trading"
...
sources: []
keyTakeaways:
  - "Revenge trading is driven by the need to undo a loss quickly, not by a genuine setup."
  - "It typically involves a larger position size and less confirmation than a trader's normal entries."
  - "A fixed cooldown period after a loss is the most direct way to interrupt the pattern."
faq:
  - question: "Does revenge trading only happen after one big loss?"
    answer: "No. It can build up after a string of small losses just as easily as after a single large one. The trigger is the accumulated frustration, not any specific size of loss."
---
