---
title: "What Is Trading Tilt?"
description: "Tilt is the state of trading from frustration or ego instead of a plan, usually right after a loss. Here is how to recognize it before it costs you more."
slug: "what-is-trading-tilt"
...
sources: []
keyTakeaways:
  - "Tilt is a temporary state of impaired decision making triggered by frustration, usually after a loss or a string of losses."
  - "The clearest sign of tilt is trading to feel better, not because a setup actually appeared."
  - "A short, fixed pause after a loss is one of the simplest ways to interrupt tilt before it compounds."
faq:
  - question: "How is tilt different from a normal losing trade?"
    answer: "A normal loss is just an outcome. Tilt is what happens after it: sizing up, skipping rules, or forcing a trade to make the loss feel undone. The trade itself is usually the tell, not the loss."
---
