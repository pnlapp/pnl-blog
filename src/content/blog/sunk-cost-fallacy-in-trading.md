---
title: "The Sunk Cost Fallacy and Why Traders Hold Losers Too Long"
description: "The money already lost on a trade is gone regardless of what happens next, but it still shapes decisions it should have no effect on. Here is how that plays out."
slug: "sunk-cost-fallacy-in-trading"
...
sources: []
keyTakeaways:
  - "The sunk cost fallacy is letting money already lost influence a decision that should only be based on the trade's current outlook."
  - "It commonly shows up as holding a losing position past the original stop, waiting to at least break even before exiting."
  - "The useful question is whether you would enter this exact position today, not how much has already been lost on it."
---
